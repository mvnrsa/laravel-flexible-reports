...
<div class="card">
    <div class="card-header">
        {{ trans('flexibleReports::reports.create') }} {{ trans('flexibleReports::reports.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reports.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('query') ? 'is-invalid' : '' }}" name="query" id="query">{{ old('query') }}</textarea>
                @if($errors->has('query'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('columns') ? 'is-invalid' : '' }}" name="columns" id="columns">{{ old('columns') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('parameters') ? 'is-invalid' : '' }}" name="parameters" id="parameters">{{ old('parameters') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('charts') ? 'is-invalid' : '' }}" name="charts" id="charts">{{ old('charts') }}</textarea>
